   ...
   <section class="flex items-center h-screen p-16 dark:bg-gray-900 dark:text-gray-100">
	<div class="container flex flex-col items-center justify-center px-5 mx-auto my-8">
		<div class="max-w-md text-center">
			...
			<p class="text-2xl font-semibold md:text-3xl">Sorry, you cant have access for this page.</p>
			<p class="mt-4 mb-8 dark:text-gray-400">But dont worry, you can find plenty of other things on our homepage.</p>
			<router-link rel="noopener noreferrer" to="/" class="px-8 py-3 font-semibold rounded bg-blue-400">Back to homepage</router-link>
		</div>
	</div>
</section>
</template>